...
import com.nas.web.model.PropertiesMapping;
import com.nas.web.model.entity.RelationModel;
import com.nas.web.serializer.LocalDateTimeDeserializer;
import com.nas.web.serializer.LocalDateTimeSerializer;
import com.nas.web.util.ReflectUtils;
import com.nas.web.util.StringUtils;
...
public class ElasticSearchService {
     ...
     * @return 文档ID
     */
    public <T> List<IndexedObjectInformation> bulkIndexDoc(String indexName, List<T> docList) {
     ...
     * @return 索引文档ID集合
     */
//    public <T> List<IndexedObjectInformation> bulkIndexSubDoc(String indexName, List<T> subDocList, String subRelationName) {
...
//    }
    ...
    public <T> String indexSubDoc(String indexName, T elasticsearchSubModel, String subRelationName) {
        if (existIndex(indexName) && elasticsearchSubModel != null) {
            ...
            List<IndexedObjectInformation> result = elasticsearchRestTemplate.bulkIndex(queries, BulkOptions.builder()
                    .withRoutingId(getDocumentParentIdValue(elasticsearchSubModel, subRelationName)).build(), IndexCoordinates.of(indexName));
            return result != null && !result.isEmpty() ? String.valueOf(result.get(0)) : null;
        }
        return null;
    }
